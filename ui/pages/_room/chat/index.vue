<template>
  <client-only>
    <v-expansion-panels
      ...
      style="height: 100%"
    >
      <v-expansion-panel v-if="room && !isRoomPeer">
      ...
      <v-expansion-panel v-if="room && isRoomPeer && roomPeers && roomPeers.length === 1">
        <v-expansion-panel-header>
          <div>
            <v-icon>
              fa-paper-plane
      ...
      <v-expansion-panel v-if="room && isRoomPeer && roomPeers && roomPeers.length >= 0">
        <v-expansion-panel-header>
          <div>
            <v-icon>
              fa-comments
