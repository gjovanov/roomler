...
const ownerMessages = new MessageContext(data.owner.message, owner, room, [owner, moderator, member])
const moderatorMessages = new MessageContext(data.moderator.message, moderator, room, [owner, moderator, member])
